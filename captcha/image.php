...
$textX = ( int ) (80 - 0.9 * $textLength * $fontSize); 	// these coefficients are
                                                    	// empiric
$textY = ( int ) ($sizeY - 0.2 * $fontSize); 			// don't try to learn how they were
                                          				// taken out
$gdInfoArray = gd_info ();
if (! $gdInfoArray ['PNG Support']) echo "error1";
...
if (! $resizeResult) echo "error1";

// write text on image
if (! function_exists ( 'imagettftext' )) echo "error";
...
$matrix_blur = array (array (- 1, - 1, - 1 ), array (- 1, 18, - 1 ), array (- 1, - 1, - 1 ) );
